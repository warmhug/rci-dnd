...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rciDnd = __webpack_require__(179);
	...
	function getState() {
	  ...
	  return {
	    data: data,
	    isInfiniteLoading: data.map(function (item) {
	      return false;
	    }),
	    containerHeight: containerHeight,
	    elementHeight: data.map(function (item) {
	      return item.cards.map(function (ii) {
	...
	var Demo = function (_Component) {
	  ...
	  _createClass(Demo, [{
	    ...
	    key: 'getCardHeight',
	    value: function getCardHeight(bIndex, index, height) {
	    ...
	    key: 'getNewInfiElementHeight',
	    value: function getNewInfiElementHeight(data) {
	    ...
	    key: 'getBlockHeight',
	    value: function getBlockHeight(bIndex, height) {
	      this.setState({
	    ...
	    value: function handleInfiniteLoad(bIndex) {
	      ...
	      this.setState({
	        isInfiniteLoading: [].concat(_toConsumableArray(this.state.isInfiniteLoading.slice(0, bIndex)), [true], _toConsumableArray(this.state.isInfiniteLoading.slice(bIndex + 1)))
	      });
	      setTimeout(function () {
	        // simulate ajax
	        var data = _this3.state.data;
	        var added = addData(true);
	        var nData = [].concat(_toConsumableArray(data.slice(0, bIndex)), [{ cards: [].concat(_toConsumableArray(data[bIndex].cards), _toConsumableArray(added)) }], _toConsumableArray(data.slice(bIndex + 1)));
	
	        cardsLen = added.length;
	
	        var elementHeight = [].concat(_toConsumableArray(_this3.state.elementHeight));
	        elementHeight[bIndex] = [].concat(_toConsumableArray(elementHeight[bIndex]), _toConsumableArray(added.map(function (ii) {
	          return defaultElementHeight;
	        })));
	
	        _this3.setState({
	          isInfiniteLoading: nData.map(function (item) {
	            return false;
	          }),
	          data: nData,
	          elementHeight: elementHeight
	    ...
	    value: function onEndDrag(e, data, extra) {
	      ...
	      if (e === 'drop') {
	        ...
	        var dragIndex = extra.dragIndex;
	        var bIndex = extra.bIndex;
	        var dropIndex = extra.dropIndex;
	
	        var removed = elementHeight[dragBIndex].splice(dragIndex, 1);
	    ...
	    value: function render() {
	      ...
	      var elementHeight = _state.elementHeight;
	      var containerHeight = _state.containerHeight;
	      var isInfiniteLoading = _state.isInfiniteLoading;
	      ...
	      return _react2["default"].createElement(
	        ...
	        _react2["default"].createElement(
	          ...
	          this.state.data.length ? this.state.data.map(function (block, index) {
	            return _react2["default"].createElement(
	              Block,
	              { key: index, index: index,
	                getBlockHeight: _this4.getBlockHeight.bind(_this4, index) },
	              _react2["default"].createElement(
	                'h3',
	              ...
	              _react2["default"].createElement(
	                'div',
	                { className: 'infi-container', ref: 'block-' + index },
	                _react2["default"].createElement(
	                  _reactInfinite2["default"],
	                  {
	                    ...
	                    onInfiniteLoad: _this4.handleInfiniteLoad.bind(_this4, index),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dnd = __webpack_require__(181);
	...
	var _block = __webpack_require__(339);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDnd = __webpack_require__(183);
	...
	var Dnd = function (_Component) {
	  ...
	  _createClass(Dnd, [{
	    ...
	    value: function onEndDrag() {
	      ...
	      var rawIndex = phIndex[0] && [].concat(_toConsumableArray(phIndex[0]));
	    ...
	    value: function recursiveCloneChildren(children) {
	      ...
	      var newC = _react2["default"].Children.map(children, function (child, index) {
	        var childProps = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dndCore = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxLibCreateStore = __webpack_require__(187);
	...
	var _actionsDragDrop = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dragOffset = __webpack_require__(192);
	
	var _dragOffset2 = _interopRequireDefault(_dragOffset);
	
	var _dragOperation = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsMatchesType = __webpack_require__(194);
	...
	var _lodashIsArray = __webpack_require__(195);
	
	var _lodashIsArray2 = _interopRequireDefault(_lodashIsArray);
	
	var _lodashIsObject = __webpack_require__(197);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsRegistry = __webpack_require__(199);
	
	var _lodashWithout = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseDifference = __webpack_require__(201),
	    isArrayLikeObject = __webpack_require__(237),
	    rest = __webpack_require__(242);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MapCache = __webpack_require__(203),
	    cachePush = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mapClear = __webpack_require__(204),
	    mapDelete = __webpack_require__(214),
	    mapGet = __webpack_require__(221),
	    mapHas = __webpack_require__(224),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = __webpack_require__(210),
	    ...
	    isKeyable = __webpack_require__(220);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var hashHas = __webpack_require__(219);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = __webpack_require__(210),
	    assocGet = __webpack_require__(222),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Map = __webpack_require__(210),
	    assocHas = __webpack_require__(225),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexOfNaN = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(234),
	    baseCastArrayLikeObject = __webpack_require__(258),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducersDragOffset = __webpack_require__(192);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getEmptyImage = __webpack_require__(322);
	
	var _getEmptyImage2 = _interopRequireDefault(_getEmptyImage);
	
	var _NativeTypes = __webpack_require__(321);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BrowserDetector = __webpack_require__(316);
	
	var _OffsetUtils = __webpack_require__(318);
	
	var _NativeDragSources = __webpack_require__(320);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lodashMemoize = __webpack_require__(317);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MonotonicInterpolant = __webpack_require__(319);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flow = __webpack_require__(324);
	...
	var Card = function (_Component) {
	  ...
	  _createClass(Card, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      this.props.getCardHeight((0, _reactDom.findDOMNode)(this).offsetHeight);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return placeholder ? _react2["default"].createElement(
	        ...
	        content
	      ) : connectDragSource(connectDropTarget(_react2["default"].createElement(
	        'div',
	        { className: (0, _classnames2["default"])(cls, className), style: style },
	        content
	      )));
	    }
	  }]);
	...
	Card.propTypes = {
	  getCardHeight: _react.PropTypes.func
	};
	Card.defaultProps = {
	  getCardHeight: function getCardHeight() {}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createFlow = __webpack_require__(325);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LodashWrapper = __webpack_require__(326),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseCreate = __webpack_require__(327),
	    baseLodash = __webpack_require__(328);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var metaMap = __webpack_require__(330),
	    noop = __webpack_require__(255);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LazyWrapper = __webpack_require__(335),
	    getData = __webpack_require__(329),
	    getFuncName = __webpack_require__(332),
	    lodash = __webpack_require__(336);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LazyWrapper = __webpack_require__(335),
	    LodashWrapper = __webpack_require__(326),
	    copyArray = __webpack_require__(338);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Block = function (_Component) {
	  ...
	  _createClass(Block, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      this.props.getBlockHeight((0, _reactDom.findDOMNode)(this).offsetHeight);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
